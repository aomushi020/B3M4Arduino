...
class B3M{
    public:
        ...
        // uint8_t write(uint8_t id_, uint8_t option_, uint8_t *data, uint8_t address_, uint8_t length_);
        // void write(uint8_t *id_, uint8_t option_, uint8_t *data, uint8_t address_, uint8_t length_, uint8_t value_);
